...
from pagesmith.refine_html import refine_html, ALLOWED_TAGS, KEEP_EMPTY_TAGS, REMOVE_WITH_CONTENT
...
def test_refine_html_attributes(test_id, input_html, expected_output):
...
def test_refine_html_br_handling(test_id, input_html, expected_output):
...
def test_refine_html_empty_elements(test_id, input_html, expected_output):
...
def test_refine_html_add_classes(test_id, input_html, expected_output, tags_with_classes):
    """Test adding classes to tags."""
    result = refine_html(input_html, tags_with_classes=tags_with_classes)
...
def test_refine_html_keep_ids(test_id, input_html, ids_to_keep, expected_tag_preserved):
    """Test preserving elements with specific IDs."""
    result = refine_html(input_html, ids_to_keep=ids_to_keep)
...
def test_refine_html_comments(test_id, input_html, expected_output):
...
def test_refine_html_whitespace(test_id, input_html, expected_output):
    """Test whitespace handling."""
    assert refine_html(input_html) == expected_output


@allure.epic("Clear HTML")
def test_refine_html_error_handling():
    """Test that refine_html handles errors gracefully and returns original input."""
    ...
    assert (
        refine_html(input_html) == "<small>begin<div><span>end<p>paragraph</p></span></div></small>"
    )


# Test complex case
@allure.epic("Clear HTML")
def test_refine_html_complex_case():
    ...
    cleaned = "".join(refine_html(input_html).split())
...
def test_refine_html_custom_tags(test_id, input_html, expected_pattern, custom_allowed_tags):
    """Test handling of custom tags with configurable allowed tags."""

    result = refine_html(input_html, allowed_tags=custom_allowed_tags or ALLOWED_TAGS)
...
@allure.epic("Clear HTML")
def test_refine_html_whitelist_nested_unknown_tags():
    ...
    cleaned = refine_html(input_html).replace(" ", "")
...
@allure.epic("Clear HTML")
def test_refine_html_adds_classes_to_tags():
    input_html = """
    <div>
    ...
    cleaned_html = refine_html(input_html, tags_with_classes=tags_with_classes)
...
@allure.epic("Clear HTML")
def test_refine_html_preserves_all_attributes_except_style_and_class():
    input_html = """
    ...
    cleaned_html = refine_html(input_html)
    soup = BeautifulSoup(cleaned_html, "html.parser")
...
class TestClearHtmlComplexEdgeCases:
    """Tests for complex edge cases in the refine_html function."""
    ...
    def test_refine_html_malformed_html(self, test_id, input_html, expected_output):
    ...
    def test_refine_html_entities_and_cdata(self, test_id, input_html, expected_output):
        """Test handling of HTML entities and CDATA sections."""
        # Clean HTML
        cleaned = refine_html(input_html)
    ...
    def test_refine_html_empty_elements_with_tail_text(self, test_id, input_html, expected_output):
    ...
    def test_refine_html_ids_to_keep_precedence(
    ...
    def test_refine_html_xml_and_special_content(self, test_id, input_html, expected_output):
    ...
    def test_refine_html_custom_keep_empty_tags(
        self, test_id, input_html, keep_empty_tags, expected_output
    ):
        """Test customization of which empty tags to keep."""
        result = refine_html(input_html, keep_empty_tags=keep_empty_tags)
    ...
    def test_refine_html_custom_tags_to_remove_with_content(
        self, test_id, input_html, tags_to_remove, expected_output
    ):
        """Test customization of which tags to remove with their content."""
        result = refine_html(input_html, tags_to_remove_with_content=tags_to_remove)
    ...
    def test_refine_html_unicode_and_special_characters(self, test_id, input_html, expected_output):
    ...
    def test_refine_html_performance_edge_cases(self, test_id, input_html, expected_output):
    ...
    def test_refine_html_special_attribute_handling(self, test_id, input_html, expected_output):
